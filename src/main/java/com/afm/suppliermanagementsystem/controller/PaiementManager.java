...
////////////
            ...
            contentParagraph.add(new Phrase("Règlement DE (T4) "+java.time.LocalDate.now().getYear()+" DE L'ASSURANCE COMPLIMENTAIRE "+java.time.LocalDate.now().getYear()+".", boldFont));
            contentParagraph.add(Chunk.NEWLINE);
            contentParagraph.add(Chunk.NEWLINE);
            contentParagraph.add(Chunk.NEWLINE);
            contentParagraph.add(Chunk.NEWLINE);
            ...
            contentParagraph.add(new Phrase(" "+setmontant+"  "+setdevise+"  ", boldFont));
...
////////////
            ...
            contentParagraph.add(Chunk.NEWLINE);
            contentParagraph.add(new Phrase("Montant           : ", boldFont));
            contentParagraph.add(new Phrase(setmontant+""+setdevise+".", boldFont));
            contentParagraph.add(Chunk.NEWLINE);
